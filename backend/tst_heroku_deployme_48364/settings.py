"""
Django settings for tst_heroku_deployme_48364 project.
...
ROOT_URLCONF = 'tst_heroku_deployme_48364.urls'
...
WSGI_APPLICATION = 'tst_heroku_deployme_48364.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "Tst Heroku Deployment Support <support@tst-heroku-deployme-48364.botics.co>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "tst_heroku_deployme_48364 API",
    "DESCRIPTION": "API documentation for tst_heroku_deployme_48364 App",
    "VERSION": "v1",
}
